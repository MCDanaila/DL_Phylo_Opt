...
def index_shared_features(dff, ind, edge, move_type, features_dicts_dict):
	...
	dff.loc[ind, FEATURES["ntaxa_p"]] = features_dicts_dict["ntaxa_p"][edge]
	dff.loc[ind, FEATURES["ntaxa_r"]] = features_dicts_dict["ntaxa_r"][edge]  		#f4,5
	dff.loc[ind, FEATURES["tbl_p"]] = features_dicts_dict["tbl_p"][edge] #f6,7
	dff.loc[ind, FEATURES["tbl_r"]] = features_dicts_dict["tbl_r"][edge]  #f6,7
	dff.loc[ind, FEATURES["longest_p"]] = features_dicts_dict["longest_p"][edge]	#f8,9	
	dff.loc[ind, FEATURES["longest_r"]] = features_dicts_dict["longest_r"][edge]	#f8,9
